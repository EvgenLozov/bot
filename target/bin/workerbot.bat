...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="workerbot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" savkin.Bot %CMD_LINE_ARGS%
